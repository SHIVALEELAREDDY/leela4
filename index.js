...
var char="S"
var upperstr=char.concat("shivureddy").toUpperCase();
...
var person={firstName:"shivu",lastName:"shivannagari",age:20};
...
var user={username:"shivureddy",email:"shivureddy@gmail.com",address:{city:"sindhanur",state:"karatanaka",zip:"584128"}}
Object.freeze(user);
user.email="shivu@gmail.com"
console.log(user);
